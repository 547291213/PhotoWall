package com.example.xkfeng.photowall.DiskLruCache;
...
public class DiskLruCacheHelper
{
    ...
    private static final int MAX_COUNT = 8 * 1024 * 1024;
	...
	*/
    ...
    public void put(String key, Bitmap bitmap)
    {
        ...
        Log.i(TAG , "putImage  key:" + key +"  bitmap:"+bitmap) ;
    }
    ...
    public Bitmap getAsBitmap(String key)
    {
        ...
        Log.i("DiskLruCacheHelper" , "getAsBitmap :" + key) ;
